...
class DswtReader(ClamsApp):
    ...
    def scene_w_multicolumn(self):
        """
        Find all scenes with text with multiple columns using coordinates of bounding box of each paragraph.
        :return: a list of timestamp of the scene with multiple columns of text.
        """
    ...
    def _annotate(self, mmif: Mmif, **parameters) -> Mmif:
        ...
        for timeframe in input_view.get_annotations(AnnotationTypes.TimeFrame):
            ...
            # Read texts from the scens in the timepoints resampled
            ...
            # save the resulted text as a textdocument in the new view.
            text_document: Document = new_view.new_textdocument(result_text)
            td_id = text_document.id
            new_view.new_annotation(AnnotationTypes.Alignment, source = target_start_id, target = td_id)
